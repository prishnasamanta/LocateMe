...
export default function Visitor() {
  ...
  const { heading: deviceHeading } = useDeviceOrientation(tracking);
  ...
  if (notFound) {
    return (
      <div className="flex min-h-dvh flex-col items-center justify-center px-6 text-center">
        ...
        <h1 className="mt-4 text-2xl font-bold text-white">Link Not Found</h1>
        <p className="mt-2 text-white/60">This destination may have expired or doesn&apos;t exist.</p>
          ...
          {geoLoading && !position ? (
            ...
            <>
              ...
              <div className="grid grid-cols-2 gap-4">
                <Compass bearingDeg={bearingDeg} deviceHeading={deviceHeading} />
                <Radar distanceKm={distanceKm ?? 5} />
              </div>
